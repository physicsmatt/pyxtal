...
#  Nov 18, 2018 11:51:32 PM CET  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top39 {base} {
    ...
    wm geometry $top 601x665+495+148
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    vTcl:DefineAlias "$top.lab41" "Labelframe2" vTcl:WidgetProc "pyxtal" 1
    ...
    vTcl:DefineAlias "$top.lab48" "inputFrame" vTcl:WidgetProc "pyxtal" 1
    ...
    place $site_4_0.ent83 \
        -in $site_4_0 -x 50 -y 32 -width 36 -height 27 -anchor nw \
        -bordermode ignore 
    ...
    place $site_4_0.ent86 \
        -in $site_4_0 -x 130 -y 32 -width 36 -height 27 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lab87 \
        -in $site_4_0 -x 190 -y 40 -width 38 -height 15 -anchor nw \
        -bordermode ignore 
    place $site_4_0.ent88 \
        -in $site_4_0 -x 220 -y 32 -width 36 -height 27 -anchor nw \
        -bordermode ignore 
    ...
    place $site_3_0.ent44 \
        -in $site_3_0 -x 120 -y 212 -width 66 -relwidth 0 -height 27 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.ent54 \
        -in $site_3_0 -x 210 -y 82 -width 66 -relwidth 0 -height 27 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    labelframe $top.lab46 \
        ...
        -height 215 -highlightcolor black -width 270 
    ...
    vTcl:DefineAlias "$site_3_0.che55" "outLogCheck" vTcl:WidgetProc "pyxtal" 1
    place $site_3_0.ent44 \
        -in $site_3_0 -x 160 -y 111 -width 76 -relwidth 0 -height 27 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.che71 \
        -in $site_3_0 -x 10 -y 30 -width 265 -relwidth 0 -height 17 \
        -relheight 0 -anchor nw -bordermode ignore 
...
Image Windows} 
    ...
    message $site_3_0.mes52 \
        ...
        -highlightcolor black -text {Files: 101/200} -width 131 
    vTcl:DefineAlias "$site_3_0.mes52" "fileMessage" vTcl:WidgetProc "pyxtal" 1
    message $site_3_0.mes53 \
        -anchor w -background {#d9d9d9} -foreground {#000000} \
        -highlightcolor black -text {Frames: 1000/10000} -width 151 
    ...
    ###################
    place $top.lab41 \
        -in $top -x 10 -y 20 -width 290 -relwidth 0 -height 335 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but43 \
        -in $top -x 470 -y 610 -width 108 -relwidth 0 -height 33 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab48 \
        -in $top -x 10 -y 370 -width 290 -relwidth 0 -height 285 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but40 \
        -in $top -x 330 -y 610 -width 108 -relwidth 0 -height 33 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab46 \
        -in $top -x 320 -y 20 -width 270 -relwidth 0 -height 215 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab57 \
        -in $top -x 320 -y 250 -width 270 -relwidth 0 -height 85 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab97 \
        -in $top -x 320 -y 350 -width 270 -relwidth 0 -height 145 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab50 \
        -in $top -x 320 -y 510 -width 270 -relwidth 0 -height 75 -relheight 0 \
        -anchor nw -bordermode ignore 
