...
#    Oct 15, 2018 09:35:21 PM CEST  platform: Linux
...
class Pyxtal_Viewer:
    def __init__(self, top=None):
        ...
        self.whichImage = StringVar(value="raw")
        ...
        self.invertCheck.configure(variable=pyxtalmain_support.invertimage)
        ...
        self.circlesCheck.configure(variable=pyxtalmain_support.showCircles)
        ...
        self.triangulationCheck.configure(variable=pyxtalmain_support.showTriang)
        ...
        self.defectsCheck.configure(command=pyxtalviewer_support.defects_visiblechangeVisibleAnnotations)
        self.defectsCheck.configure(justify=LEFT)
        self.defectsCheck.configure(text='''defects''')
        self.defectsCheck.configure(variable=pyxtalmain_support.showDefects)
        ...
        self.orientationCheck.configure(variable=pyxtalmain_support.showOrientation)
        ...
        self.trajectCheck.configure(variable=pyxtalmain_support.showTraject)
        self.trajectCheck.configure(width=116)
        ...
        self.statsCheck.configure(variable=pyxtalmain_support.showStats)
        ...
        self.imgCanvas.bind('<Button-1>',lambda e:pyxtalviewer_support.xxx(e))
        self.imgCanvas.bind('<ButtonRelease-1>',lambda e:pyxtalviewer_support.xxx(e))
        #self.imgCanvas.bind('<Motion>',lambda e:pyxtalviewer_support.xxx(e))
        ...
        self.imgCanvas.bind('<Button-4>',lambda e:pyxtalviewer_support.xxx(e))
        self.imgCanvas.bind('<Button-5>',lambda e:pyxtalviewer_support.xxx(e))
