...
#    Oct 20, 2018 06:33:47 PM CEST  platform: Linux
...
#        imageSize=[-1]
        ...
        self.doTraject = BooleanVar()
        self.retainWin = BooleanVar()
        self.lockViews = BooleanVar()
        self.lockZoom = BooleanVar()
        self.fromFrameStr=StringVar()
        self.toFrameStr=StringVar()
        self.byFrameStr=StringVar()
        self.sphereSizeStr=StringVar()
        self.imageSizeStr=StringVar()
